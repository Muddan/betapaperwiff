  ...
  <v-container fluid grid-list-md>
    <v-layout row wrap>
      <div class="story-loader">
        <v-progress-circular v-if="!stories.length" indeterminate color="#f45b69"></v-progress-circular>
      </div>
      <v-flex class="story-items-main" v-for="(item, index) in stories" :key="index">
        <v-list two-line>
          <template>
            <v-layout>
            ...
            <v-container class="story-content-main">
              ...
              <story-tags :tags="item.tags"></story-tags>
            </v-container>
